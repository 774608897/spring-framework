...
/**
 * 描述了bean实例的定义，包括属性值，构造方法，和继承自他的类的更多信息。<br>
 * {@link AttributeAccessor} {@link BeanMetadataElement}
 * <p>
 * 常用的实现类<br>
 * {@link ChildBeanDefinition}<br>
 * {@link RootBeanDefinition}<br>
 * {@link GenericBeanDefinition}<br>
 * 
 * 如果配置文件中定义了父<bean>和子<bean>，则父<bean>用RootBeanDefinition表示，子<bean>用ChildBeanDefinition表示，
 * 而没有父<bean>的就使用RootBeanDefinition 表示。<br>
 * 
...
public interface BeanDefinition extends AttributeAccessor, BeanMetadataElement {
	...
	/**
	 * Set the role hint for this {@code BeanDefinition}. The role hint provides the
