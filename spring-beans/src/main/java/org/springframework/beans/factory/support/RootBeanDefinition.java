...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/** 构造函数的缓存锁Common lock for the four constructor fields below. */
	final Object constructorArgumentLock = new Object();

	/** 缓存已经解析的构造函数或者工厂方法Package-visible field for caching the resolved constructor or factory method. */
	@Nullable
	...
	/** 缓存已经解析的构造函数参数，包可见字段。Package-visible field for caching fully resolved constructor arguments. */
	@Nullable
